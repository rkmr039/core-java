...
public class SearchStockServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		((ServletOutputStream) out).println(stock.getStockId());
		((ServletOutputStream) out).println(stock.getItemName());
		((ServletOutputStream) out).println(stock.getPrice());
		((ServletOutputStream) out).println(stock.getQuantityAvail());
