...
public class ShowEnvServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	        ...
	        out.println("<br/>Servlet Port Number : " + request.getServerPort());
	        
	        out.println("<br/>Client Ip Address : " + request.getRemoteUser());
	        out.println("<br/>Remote User : " + request.getRemoteHost());
	}
