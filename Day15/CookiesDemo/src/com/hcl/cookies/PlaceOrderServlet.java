...
public class PlaceOrderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (int j=0; j<i;j++) {
			out.println("PRODUCT  : " + j+1 + "<br/>");
			out.println("ID       : " + orders[j][0]+ "<br/>");
			out.println("Name     : " + orders[j][1]+ "<br/>");
			out.println("Quantity : " + orders[j][2]+ "<br/>");
			out.println("Unit Of Measure : " + orders[j][3]+ "<br/>");
			out.println("=============================<br/>");
		}
		out.println("<br/><br/>");
